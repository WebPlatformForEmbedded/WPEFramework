...
OpenCDMError opencdm_system_ext_get_ldl_session_limit(OpenCDMSystemExt* system,
    uint32_t* ldlLimit)
{
...
bool opencdm_system_ext_is_secure_stop_enabled(
    struct OpenCDMSystemExt* system)
{
    OpenCDMAccessor* accessor = system->m_accessor;
...
OpenCDMError
opencdm_system_ext_enable_secure_stop(struct OpenCDMSystemExt* system,
    uint32_t use)
{
    OpenCDMAccessor* accessor = system->m_accessor;
...
OpenCDMError opencdm_system_ext_get_secure_stop_ids(OpenCDMSystemExt* system,
    uint8_t ids[],
    uint8_t idSize,
    uint32_t* count)
{
...
OpenCDMError opencdm_system_ext_get_secure_stop(OpenCDMSystemExt* system,
...
OpenCDMError opencdm_system_ext_commit_secure_stop(
    OpenCDMSystemExt* system, const uint8_t sessionID[],
...
OpenCDMError opencdm_get_key_store_hash_ext(struct OpenCDMSystemExt* system,
...
OpenCDMError opencdm_get_secure_store_hash_ext(struct OpenCDMSystemExt* system,
