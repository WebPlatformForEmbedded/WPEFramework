...
namespace JsonData {
    ...
    namespace WifiControl {
        ...
        class PairingInfo : public Core::JSON::Container {
        public:
            PairingInfo()
                : Core::JSON::Container()
            {
            ...
            PairingInfo(const PairingInfo& other)
                : Core::JSON::Container()
                , Method(other.Method)
                , Keys(other.Keys)
            {
            ...
            PairingInfo& operator=(const PairingInfo& rhs)
            {
                Method = rhs.Method;
                Keys = rhs.Keys;
                return (*this);
        ...
        public:
            Core::JSON::String Ssid; // Identifier of a network (32-bytes long)
            Core::JSON::ArrayType<PairingInfo> Pairing;
